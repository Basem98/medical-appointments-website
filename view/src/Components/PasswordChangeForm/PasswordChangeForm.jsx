...
const PasswordChangeForm = () => {
  ...
  return (
    <Grid container style={{ background: theme.palette.linearFormBg.main, minHeight: '80vh', paddingTop: '100px' }} flexDirection='column' justifyContent='center' alignItems='center'>
